...
define('SECRET_SALT','D3RHSPp8ofJ1tRIHa_d5nvhmSQZOE9aN');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','mouhamed.kanoute@wari.com');
...
define('DBNAME','waricc');
define('DBUSER','waricallcenter');
define('DBPASS','wariit');
